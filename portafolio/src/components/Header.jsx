...
const content = {
    es: {
        ...
        description:
          ...
          También tengo conocimientos en DevOps, incluyendo el uso de Docker, Docker-Compose, Kubernetes, Jenkins y pipelines CI/CD, lo que me permite contribuir activamente en entornos de integración y entrega continua.
          Cuento con más de 2 años de experiencia como QA Engineer, especializándome en pruebas exploratorias, pruebas de integración de APIs (usando Jest, SuperTest, Postman y Newman) y pruebas automatizadas con Selenium, asegurando productos de alta calidad y confiabilidad.
      ...
      en: {
        ...
        description:
          ...
          I also have knowledge in DevOps, including the use of Docker, Docker-Compose, Kubernetes, Jenkins, and CI/CD pipelines, which allows me to actively contribute in continuous integration and delivery environments.
          I have over 2 years of experience as a QA Engineer, specializing in exploratory testing, API integration testing (using Jest, SuperTest, Postman and Newman), and automated testing with Selenium, ensuring high-quality and reliable products.
